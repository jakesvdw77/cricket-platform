...
export function GridNavShell({ brand, user, onLogout, profileTo, homeTo, children }: GridNavShellProps) {
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      <ShellHeader brand={brand} user={user} onLogout={onLogout} profileTo={profileTo} homeTo={homeTo} />
