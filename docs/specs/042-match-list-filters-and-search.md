...
- New function `listMatchFilterOptions(clubId, params): Promise<{ sectionIds: string[]; leagueIds: string[]; seasonIds: string[] }>` calling the new endpoint.
